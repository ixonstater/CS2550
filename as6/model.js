...
function GameModel() {
    this.initialJsonData = this.readData()
    this.initialData = JSON.parse(this.initialJsonData)
    this.grid = this.initialData.boardState
    this.gameName = this.initialData.gameName
    this.startDate = this.initialData.startDate
}
...
GameModel.prototype.readData = function (){
    ...
    req.open('get', 'sample_data.json', false)
    req.send(null)
